...
public class PursueAStar2 : MonoBehaviour {
    ...
    public MovementBehavior2 movement;
    ...
    List<Waypoint> BuildPath(Vector3 generalDirection) {
        ...
        try {
            targetPoint = target.GetComponent<PlayerMovement2>().currentWaypointPlayer;
        }
